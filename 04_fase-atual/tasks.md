...
|---|---|---|---|---|---|---|---|---|---|
| T1.1 | Configurar papéis e acesso mínimo | Produto | SPEC-1-001 | CA-1-12: acesso sem permissão é negado | RED-001/GREEN-001 | log de autorização + captura | escopo aprovado | A | ☐ |
| T1.2 | Implementar trilha crítica, retenção e revogação de sessão | Produto | SPEC-1-001 | CA-1-14, CA-1-15 e CA-1-16 | RED-002/GREEN-002/REG-001 | log antes/depois + política/teste de retenção + sessão invalidada | T1.1 | B | ☐ |
